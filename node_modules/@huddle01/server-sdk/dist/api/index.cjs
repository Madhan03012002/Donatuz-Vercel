...
var chunkU2R3TVIW_cjs = require('../chunk-U2R3TVIW.cjs');
...
var API = class {
  ...
  constructor(data) {
    ...
    this.#infraClient = chunkU2R3TVIW_cjs.getInfraClient({
      apiKey: this.#apiKey
    });
  }
  /**
  ...
  createRoom = async (data) => {
    try {
      ...
      if (data?.metadata && chunkNJUEGIAO_cjs.estimateSize(data.metadata) > chunkXOCRQBXE_cjs.MAX_ROOM_METADATA_SIZE) {
